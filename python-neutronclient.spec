...
Source0  : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-6.9.0.tar.gz
Source99 : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-6.9.0.tar.gz.asc
...
%prep
%setup -q -n python-neutronclient-6.9.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1532270741
