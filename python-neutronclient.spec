...
Version  : 2.4.0
Release  : 12
URL      : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-2.4.0.tar.gz
Source0  : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-2.4.0.tar.gz
...
%prep
%setup -q -n python-neutronclient-2.4.0
