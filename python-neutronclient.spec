...
Source0  : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-7.0.0.tar.gz
Source1  : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-7.0.0.tar.gz.asc
...
%prep
%setup -q -n python-neutronclient-7.0.0
cd %{_builddir}/python-neutronclient-7.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581608823
...
cp %{_builddir}/python-neutronclient-7.0.0/LICENSE %{buildroot}/usr/share/package-licenses/python-neutronclient/294b43b2cec9919063be1a3b49e8722648424779
