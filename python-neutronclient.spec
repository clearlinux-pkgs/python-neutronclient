...
Version  : 4.1.1
Release  : 20
URL      : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-4.1.1.tar.gz
Source0  : http://tarballs.openstack.org/python-neutronclient/python-neutronclient-4.1.1.tar.gz
...
%prep
%setup -q -n python-neutronclient-4.1.1
